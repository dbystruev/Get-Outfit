...
extension AllQuestions on Question {
  static List<List<Question>> _local;
  static List<List<Question>> get local {
    ...
    _local = [
      ...
      [
        ...
        Question('Давайте познакомимся. Как вас зовут?', isEnabled: false),
      ...
      [
        ...
        Question.range('Сколько вы бы потратили на джинсы или брюки? (₽)', 500,
            25500, 50000),
        Question.rangeFemale(
            'Сколько вы бы потратили на платье? (₽)', 1000, 25500, 50000),
        Question.range('Сколько вы бы потратили на куртку или пиджак? (₽)', 500,
            50500, 100000),
        Question.range(
      ...
      [
        ...
        Question('Ваш e-mail', isEnabled: false),
        Question('Ваш мобильный телефон', isEnabled: false),
      ],
    ];
    return _local;
  }
